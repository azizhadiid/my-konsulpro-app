                ...
                <nav className="flex-1 px-4 py-6 space-y-2">
                    {menuItems.map((item) => (
                        <a
                            ...
                            className={`flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 group ${activeItem === item.id
                                ? 'bg-blue-50  text-blue-600  shadow-sm'
                                : 'text-gray-700  hover:bg-gray-50  hover:text-gray-900 '
                                }`}
                        >
                            <div className={`transition-colors duration-200 ${activeItem === item.id ? 'text-blue-600 ' : 'text-gray-500 group-hover:text-gray-700'
                                }`}>
                                {item.icon}
                            </div>
