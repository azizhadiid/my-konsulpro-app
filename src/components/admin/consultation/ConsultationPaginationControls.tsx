...
interface ConsultationPaginationControlsProps {
    currentPage: number;
    totalPages: number;
    totalItems: number;
    perPage: number;
...
const ConsultationPaginationControls: React.FC<ConsultationPaginationControlsProps> = ({
    currentPage,
    totalPages,
    totalItems,
    perPage,
    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-between mt-8 space-y-4 md:space-y-0">
            <div className="text-sm text-gray-700 dark:text-gray-300">
                Menampilkan {startIndex} sampai {endIndex} dari {totalItems} konsultasi
            </div>
            <div className="flex items-center space-x-4">
                <label htmlFor="perPage" className="text-gray-700 dark:text-gray-300 text-sm font-medium">Item per halaman:</label>
                <select
                    id="perPage"
                    value={perPage}
...
export default ConsultationPaginationControls;